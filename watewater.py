...
print(f'\nArea 1 Expected: {area1[0]}')
print(f'Area 1 Actual:   {area1_enc.decrypt()[0]}')


area2 = (C_T2*D_T2) - (C_S*D_S)
area2_enc = (C_T2_ENC*D_T2_ENC) - (C_S_ENC*D_S_ENC)
print(f'\nArea 2 Expected: {area2[0]}')
print(f'Area 2 Actual:   {area2_enc.decrypt()[0]}')


area3 = ((C_T3*D_T3) - (A_M2*(B_M2*CONST1))) - (E-F)
area3_enc = ((C_T3_ENC*D_T3_ENC) - (A_M2_ENC*(B_M2_ENC*CONST1_ENC))) - (E_ENC-F_ENC)
print(f'\nArea 3 Expected: {area3[0]}')
print(f'Area 3 Actual:   {area3_enc.decrypt()[0]}')
